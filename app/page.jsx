...
const BACKEND_ROUTE = "http://34.69.203.156:80/api/routes/";

const mainContractAbi = require("./MainContract.json").abi;
const mainContractAddress = "0xA0f63BDea47D484f189865FF76D4FB6184e2B171";
...
export default function Home() {
          ...
          prevAgents.map((agent) => ({
            ...
            contributions: [
              ...agent.contributions,
              {
                ...
                iteration: 0,
                message: JSON.parse(data.response_data).iteration_0[
                  agent.model_id
                ].reason,
              ...
              },
              {
                ...
                iteration: 1,
                message: JSON.parse(data.response_data).iteration_1[
                  agent.model_id
                ].reason,
                timestamp: new Date().toISOString(),
              },
  ...
  const sendCreateAccountTransaction = async () => {
    if (awaitingCreateAccount) {
      ...
      const header = ethers.utils.arrayify("0x" + newAccountInfo.header);
      const payload = ethers.utils.arrayify("0x" + newAccountInfo.payload);
      const signature = ethers.utils.arrayify("0x" + newAccountInfo.signature);
        ...
        <div className="flex flex-row gap-4 justify-between items-center">
          ...
          <div style={{ textAlign: "center", padding: "20px" }}>
            {account ? (
              ...
              <Button onClick={connectWallet} color="grey" variant="outline">
                🦊 {"  "} Connect MetaMask
              </Button>
            )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 flex-grow">
          ...
          <div className="lg:col-span-7">
                            ...
                            {message.confidences && (
                              <div className="mt-3">
                                <div className="flex flex-row gap-2 m-auto">
                                  ...
                                  >
                                    <Progress.Section
                                      value={message.confidences[0] * 120}
                                      color="#e61f57"
                                    >
                                      <Progress.Label>
                                        {message.confidences[0].toFixed(4)}
                                      </Progress.Label>
                                    </Progress.Section>
                                  </Progress.Root>
                                </div>
                                <div className="flex flex-row gap-2">
                                  ...
                                  >
                                    <Progress.Section
                                      value={message.confidences[1] * 120}
                                      color="#e61f57"
                                    >
                                      <Progress.Label>
                                        {message.confidences[1].toFixed(4)}
                                      </Progress.Label>
                                    </Progress.Section>
                                  </Progress.Root>
                                </div>
            ...
            <div className="flex flex-row gap-4 justify-end mt-3 align-center">
              <p className="text-l" style={{ lineHeight: "30px" }}>
                Powered by:
              </p>
              <img
                src="/flare-flr-logo.png"
                alt="Flare FLR Logo"
                className="h-8"
              />
